      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className='relative mt-1'>
          ...
          <Transition
            ...
            leaveTo='opacity-0'
          >
            <Listbox.Options className='absolute z-50 mt-1 max-h-40 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm'>

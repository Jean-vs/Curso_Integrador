...
const data = [
  {
    ...
    text: "Nueva tarea ha sido asignada a ti y a 2 más. La prioridad de la tarea es normal, así que revisa y actúa en consecuencia. La fecha de la tarea es Jue Feb 29 2024. ¡Gracias!",
    task: null,
    notiType: "alert",
    isRead: [],
  ...
  },
  {
    ...
    text: "Nueva tarea ha sido asignada a ti y a 2 más. La prioridad de la tarea es alta, así que revisa y actúa en consecuencia. La fecha de la tarea es Vie Feb 09 2024. ¡Gracias!",
    task: {
